...
//       const result = await runCustodialTransaction(mnemonic.correct)(
//         "Currency",
//         "approve",
...
describe("GET /api/v1/assets/:address/:mainnetAddress?", () => {
  ...
  test("returns a assets list with a correct address and a correct mainnetAddress", async () => {
    try {
      const [mainnetAssets, custodialAssets] = await Promise.all([
        (async () => {
