  ...
  return (
    <Box className={classes.rootBox}>
      ...
      <Typography variant={"subtitle1"} className={classes.marginTop8}>
        Mainnet Status:
        {
          (getCustodialChainUrlData?.mainnetContractDeployed == "true" && getCustodialChainUrlData?.infuraApiKey) ? (<span className={classes.green}>Configured</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      ...
      <Typography variant={"subtitle1"} className={classes.marginTop8}>
        Polygon Status:
        {
          (getCustodialChainUrlData?.polygonContractDeployed == "true" && getCustodialChainUrlData?.polygonApiKey) ? (<span className={classes.green}>Configured</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      <Typography>
