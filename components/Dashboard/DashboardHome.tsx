  ...
  return (
    <Box className={classes.rootBox}>
      <Typography variant={"subtitle1"}>
        Sidechain Status:
        {
          getCustodialChainUrlData?.custodialContractDeployed == "true" ? (<span className={classes.green}>Configured</span>) : <span className={classes.red}>Not Ready</span>
        }
      ...
      <Typography variant={"subtitle1"} className={classes.marginTop8}>
        Mainnet Status:
        {
          (getCustodialChainUrlData?.mainnetContractDeployed == "true" && getCustodialChainUrlData?.infuraApiKey) ? (<span className={classes.green}>Configured ({getCustodialChainUrlData.infuraApiKey})</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      <Typography>
      ...
      <Typography variant={"subtitle1"} className={classes.marginTop8}>
        Polygon Status:
        {
          (getCustodialChainUrlData?.polygonContractDeployed == "true" && getCustodialChainUrlData?.polygonApiKey) ? (<span className={classes.green}>Configured ({getCustodialChainUrlData.polygonApiKey})</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      <Typography>
