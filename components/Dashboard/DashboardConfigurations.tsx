  ...
  switch (action.type) {
    ...
    case LocalAction.SETLOADVALUE: {
      ...
      return {
        ...
        custodialChainURL: data?.custodialChainURL,
...
const DashboardConfigurations: React.FunctionComponent = () => {
  ...
  const getCustodialChainData = () => {
    reduxDispatch(getCustodialChainUrl())
  }
  ...
  useEffect(() => {
    if (getCustodialChainUrlData && getCustodialChainUrlData['email']) {
      console.log("getCustodialChainUrlData ", getCustodialChainUrlData);
      dispatch({
        type: LocalAction.SETLOADVALUE,
        payload: { data: getCustodialChainUrlData },
      })
    }
  ...
  return (
    ...
    <Box className={classes.rootBox}>
      <Typography variant={"subtitle1"}>
        Infura API Key:
        {
          getCustodialChainUrlData?.infuraApiKey ? (<span className={classes.green}>Configured ({getCustodialChainUrlData.infuraApiKey})</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      <Typography>
      ...
      <Typography variant={"subtitle1"} className={classes.marginTop8}>
        Matic Vigil API Key:
        {
          getCustodialChainUrlData?.polygonApiKey ? (<span className={classes.green}>Configured ({getCustodialChainUrlData.polygonApiKey})</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      <Typography>
      ...
      <Typography variant={"subtitle1"} className={classes.marginTop8}>
        Pinata API Key:
        {
          getCustodialChainUrlData?.pinataApiKey ? (<span className={classes.green}>Configured ({getCustodialChainUrlData.pinataApiKey})</span>) : <span className={classes.red}>Not Ready</span>
        }
      </Typography>
      <Typography>
